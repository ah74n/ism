...
function App() {
  ...
  const getVerdictColor = () => {
    ...
    // Fallback logic to prevent crashes
  ...
  const getFinalVerdict = () => {
    ...
    if (result.risk_score >= 30) return "SUSPICIOUS";
    return "SAFE";
  };
  ...
  return (
    <div className="app-container">
      ...
      <header className="app-header">
        ...
        <div className="brand">
       <img src={logo} alt="isMalicious" className="logo" />
       <h1>isMalicious</h1>
    </div>
          ...
          <div className="left-panel">
            ...
            <div className="metrics-grid">
              ...
              <div className="metric-card">
                ...
                <div className="metric-value">
                  <h2>{result.ml_analysis?.confidence || 0}%</h2>
                </div>
              </div>
            </div>
            ...
            <div className="risk-bar-container">
              <div className="risk-header">
                ...
                <span style={{ color: getVerdictColor() }}>
                   {(result.status || result.final_verdict || "UNKNOWN").toUpperCase()}
                </span>
              </div>
            ...
            <div className="ml-box">
              ...
              <div className="ml-stats">
                <div className="ml-stat-row">
                  <span className="ml-label">Classification Signal</span>
                  <span className="ml-value highlight" style={{ color: getVerdictColor() }}>
                    {result.ml_analysis?.prediction?.toUpperCase() || "UNKNOWN"}
                  </span>
                </div>
                <div className="ml-stat-row">
                  <span className="ml-label">Model Confidence</span>
                  <span className="ml-value">
                    {result.ml_analysis?.confidence || 0}%
                  </span>
                </div>
                <div className="ml-stat-row">
                  <span className="ml-label">Engine Combination</span>
                  <span className="ml-value muted">Heuristics + DNS + AI</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="app-footer">
        <div className="footer-disclaimer">
          ⚠️ <strong>Disclaimer:</strong> This tool is for educational and research purposes and it is under continuos development. The ML subsystem may produce false positives.
        </div>
        <div className="footer-meta">
          <span className="developer-tag">Designed & Developed with 🧠</span>
